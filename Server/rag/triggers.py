from rag.policies import CHANNEL_CHECK_TEST, CHANNEL_COMBAT_TEST, CHANNEL_GAME, CHANNEL_START_GAME, RagPolicy


def should_retrieve(policy: RagPolicy, query: str, context: dict | None) -> bool:
    if policy.mode == "always":
        return True
    if policy.channel in (CHANNEL_GAME, CHANNEL_CHECK_TEST, CHANNEL_COMBAT_TEST):
